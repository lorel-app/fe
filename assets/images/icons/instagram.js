const instagram = [
  {
    ...
    props: {
      ...
      stops: [
        { offset: '0', stopColor: '#fd5' },
        { offset: '.328', stopColor: '#ff543f' },
        { offset: '.348', stopColor: '#fc5245' },
        { offset: '.504', stopColor: '#e64771' },
        { offset: '.643', stopColor: '#d53e91' },
        { offset: '.761', stopColor: '#cc39a4' },
        { offset: '.841', stopColor: '#c837ab' }
      ]
    }
  },
  {
  ...
  },
  {
    ...
    props: {
      ...
      gradientUnits: 'userSpaceOnUse',
      stops: [
        { offset: '0', stopColor: '#4168c9' },
        { offset: '.999', stopColor: '#4168c9', stopOpacity: '0' }
      ]
    }
  },
  {
